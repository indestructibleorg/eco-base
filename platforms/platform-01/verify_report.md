...
**生成時間**: 2026-02-25T03:40:20.165454
**系統版本**: 3.0.0
**整體狀態**: ✅ PASS
**總耗時**: 9.868s
**連續運行**: 第 1 次
...
| 測試項 | 狀態 | 耗時 | 說明 |
|--------|------|------|------|
| decision.schema.json 有效性 | ✅ | 77ms | Schema 格式正確 |
| action.schema.json 有效性 | ✅ | 5ms | Schema 格式正確 |
| run.schema.json 有效性 | ✅ | 4ms | Schema 格式正確 |
| 版本號 semver 格式 | ✅ | 4ms | 所有版本號符合 semver |
| sample decision 驗證 | ✅ | 4713ms | Decision 符合 schema |
